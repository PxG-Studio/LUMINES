        ...
        <section className="container mx-auto px-4 py-20 sm:py-32">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href={"/ignis#playground" as Route}
        ...
        <section className="container mx-auto px-4 py-20">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <Link href={"/spark" as Route} className="glass-container p-6 text-center transition-all duration-300 hover:-translate-y-2 hover:shadow-xl">
              ...
              <Link href={"/nerva" as Route} className="glass-container p-6 text-center transition-all duration-300 hover:-translate-y-2 hover:shadow-xl">
                <div className="w-16 h-16 rounded-lg bg-ignis-primary/10 border border-ignis-primary/20 flex items-center justify-center mx-auto mb-4">
