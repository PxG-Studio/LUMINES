...
<Meta
  title="Lumenforge.io Docs/WIS2L Framework/Landing"
  id="wis2l-landing-docs-app"
  name="Landing App Docs"
/>

# LANDING - Main Gateway

The **LANDING** subsystem is the primary entry point into the WIS2L Framework ecosystem and the marketing surface for **Lumenforge.io**.
...
- Storybook exposes multiple views of the landing experience:
  - `WIS2L Framework/Landing/Pages/Main Gateway` – Next.js-based landing page (`src/app/landing/page.tsx` → `LandingLayout`).
