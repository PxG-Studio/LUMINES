...
export function Button({ variant = "default", style, loading, ...props }: ButtonProps) {
  const theme = useTheme();
  ...
  // Do not forward non-standard 'loading' to the DOM; expose as data attribute for snapshots.
  const { loading: _omitted, ...rest } = props;
...
>>>>>>> d5a6537 (Chore: silence UI warnings (loading attr, runtime status))
