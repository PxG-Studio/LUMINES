...
<Meta
  title="Lumenforge.io Design System/Application Pages/Projects/Documentation/Projects"
  id="wis2l-projects-docs-stories"
  name="Projects WIS2L Docs"
/>

# PROJECTS - Project Initialization System

**PROJECTS** kickstarts new projects with intelligent scaffolding, best practices, and seamless WIS2L integration.

## Purpose

PROJECTS automates project setup by:
...
- **WIS2L Integration**: Automatic subsystem connections
...
$ projects generate my-app --template nextjs
...
PROJECTS uses templates with smart replacements:
